...
export default function GlobalError({
  ...
  return (
    <div className="mx-auto max-w-[840px] px-gutter-mobile py-16 lg:px-gutter-desktop">
      ...
      <p className="mt-5 max-w-[60ch] text-[19px] leading-[1.65] text-ink-body">
      ...
      <button
        type="button"
        onClick={reset}
        className="mt-8 inline-flex min-h-tap items-center border border-crimson-edge bg-crimson px-[26px] py-[17px] font-display text-[13px] font-semibold uppercase tracking-[1.6px] text-on-crimson"
      >
        RÉESSAYER
      </button>
    </div>
