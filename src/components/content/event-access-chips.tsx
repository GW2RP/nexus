...
/** Ce que la puce de type ne dit pas : qui voit la scène, de quel cercle elle
 *  relève, et si elle revient.
 *
...
export function EventAccessChips({
  ...
  event: Pick<EventSummary, "visibility" | "group" | "series" | "cancelled">;
  onImage?: boolean;
}) {
